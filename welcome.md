...
- [Discord](https://discord.com/) the video conferencing tool we use. You won't be able to use MS Teams on the Mac and we have no money for commercial tools. So, instead the tech team use **Discord** as our video conferencing tool as it is not only free, but places no limits on meeting times or the number attending
